create temp table OT_LINE distkey (ORGNL_CLM_NUM_LINE) sortkey (
...
from
    OT_LINE_PRE_NPPES as A
    left join nppes_npi nppes on nppes.prvdr_npi = a.PRSCRBNG_PRVDR_NPI_NUM
    left join ccs_proc ccs on ccs.cd_rng = a.prcdr_cd