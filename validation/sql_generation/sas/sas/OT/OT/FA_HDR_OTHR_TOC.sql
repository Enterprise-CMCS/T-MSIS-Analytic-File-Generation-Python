create temp TABLE FA_HDR_OTHR_TOC distkey(ORGNL_CLM_NUM) sortkey(
    TMSIS_RUN_ID,
    SUBMTG_STATE_CD,
    ORGNL_CLM_NUM,
    ADJSTMT_CLM_NUM,
...
from
    ALL_HEADER_OTHR_TOC H
    inner join HEADER_OTHR_TOC A on H.SUBMTG_STATE_CD = A.SUBMTG_STATE_CD
