create or replace temporary view ELG00002_202111_uniq as
select
    comb.*,
    ...
    case
        ...
        when coalesce(d.DECEASED_FLG, 0) = 1 then floor(datediff(d.DEATH_DATE, comb.BIRTH_DT) / 365.25)
        else floor(datediff(to_date('2021-11-01'), comb.BIRTH_DT) / 365.25)
    end as AGE_CALC,
    case
