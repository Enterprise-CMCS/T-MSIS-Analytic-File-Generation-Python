create table Prov04_Licensing_Latest1 diststyle key distkey(submitting_state_prov_id) compound sortkey (
    tms_run_id,
    submitting_state,
...
from
    ...
    inner join #Prov03_Locations_g0 R 
    on T.tms_run_id = R.tms_run_id
