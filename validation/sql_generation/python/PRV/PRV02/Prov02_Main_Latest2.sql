create
or replace temporary view Prov02_Main_Latest2 as
select
    T.*
from
    Prov02_Main_Copy T -- left join
...
where
    (
        T.prov_attributes_eff_date <= to_date('2021-10-31')
        and (
            T.prov_attributes_end_date >= to_date('2021-10-01')
