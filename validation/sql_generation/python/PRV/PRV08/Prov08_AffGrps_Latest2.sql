create
or replace temporary view Prov08_AffGrps_Latest2 as
select
    T.*
from
    Prov08_AffGrps_Copy T -- left join
...
where
    (
        T.prov_affiliated_group_eff_date <= to_date('2021-10-31')
        and (
            T.prov_affiliated_group_end_date >= to_date('2021-10-01')
