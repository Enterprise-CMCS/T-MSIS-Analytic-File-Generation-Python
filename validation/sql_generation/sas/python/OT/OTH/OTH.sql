create
or replace temporary view OTH as
select
    6194 as DA_RUN_ID,
    ...
    case
        ...
        else nullif(SRVC_BGNNG_DT_HEADER, to_date('1960-01-01'))
    ...
    case
        ...
        else nullif(ADJDCTN_DT, to_date('1960-01-01'))
    end as ADJDCTN_DT,
    case
    ...
    case
        when (BENE_COINSRNC_PD_DT < to_date('1600-01-01')) then to_date('1599-12-31')
    ...
    case
        when (BENE_COPMT_PD_DT < to_date('1600-01-01')) then to_date('1599-12-31')
    ...
    case
        when (BENE_DDCTBL_PD_DT < to_date('1600-01-01')) then to_date('1599-12-31')
    ...
    case
        when (CPTATD_AMT_RQSTD_DT < to_date('1600-01-01')) then to_date('1599-12-31')
