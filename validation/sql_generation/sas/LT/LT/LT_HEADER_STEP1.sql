CREATE TEMP TABLE LT_HEADER_STEP1 distkey (ORGNL_CLM_NUM) sortkey(
    NEW_SUBMTG_STATE_CD,
    ORGNL_CLM_NUM,
    ADJSTMT_CLM_NUM,
    ADJDCTN_DT,
...
select
    a.*,
    ccs_dx.dflt_ccsr_ctgry_LT :: varchar(6) as dgns_1_ccsr_dflt_ctgry_cd,
    ...
    end as LT_SUD_TAXONOMY_IND_HDR
from
    LT_HEADER a
