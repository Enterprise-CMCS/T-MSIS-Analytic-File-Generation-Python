CREATE TEMP TABLE OT_TAXONOMY distkey (ORGNL_CLM_NUM_LINE) sortkey(
...
select
    ...
    max(
        case
            ...
            and SRVCNG_PRVDR_NPPES_TXNMY_CD is null then null
