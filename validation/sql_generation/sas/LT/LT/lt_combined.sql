create temp table lt_combined as
select
    b.*,
    case
        when (
    ...
    case
        when (
            ...
            and (
                ...
                or (
                    bill_type_cd_upd is null
                    and dgns_1_cd is null
                )
            )
        ) then 1
        else 0
    ...
    (
        ...
        from
            (
                ...
                from
                    lt_header_0 h
                    left join lt_lne l on h.submtg_state_cd = l.submtg_state_cd
                    and h.lt_link_key = l.lt_link_key
            ) a
    ) b