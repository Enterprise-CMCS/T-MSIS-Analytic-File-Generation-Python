CREATE TEMP TABLE OT_HEADER_STEP1 distkey (ORGNL_CLM_NUM) sortkey(
    NEW_SUBMTG_STATE_CD,
    ORGNL_CLM_NUM,
    ADJSTMT_CLM_NUM,
    ADJDCTN_DT,
...
select
    a.*,
    ccs_dx.dflt_ccsr_ctgry_OT :: varchar(6) as dgns_1_ccsr_dflt_ctgry_cd,
    ...
    case
        when TEMP_TAXONMY is NULL
        and BLG_PRVDR_NPPES_TXNMY_CD is NULL then null
    ...
    end as OT_SUD_TAXONOMY_IND_HDR
from
    OT_HEADER a
