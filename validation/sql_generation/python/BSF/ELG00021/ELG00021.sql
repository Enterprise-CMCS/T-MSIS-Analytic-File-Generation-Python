create
or replace temporary view ELG00021 as
select
    a.TMSIS_RUN_ID,
    a.TMSIS_ACTV_IND,
    case
    ...
    a.TMSIS_RPTG_PRD
from
    tmsis.TMSIS_ENRLMT_TIME_SGMT_DATA as a -- left join
...
where
    (
        a.TMSIS_ACTV_IND = 1
        and (
            ENRLMT_EFCTV_DT <= to_date('2021-11-30')
            and (
                ENRLMT_END_DT >= to_date('2021-11-01')
