create
or replace temporary view ELG00003A as
select
    a.TMSIS_RUN_ID,
    a.TMSIS_ACTV_IND,
    a.PRGNT_IND,
    ...
    a.TMSIS_RPTG_PRD
from
    tmsis.TMSIS_VAR_DMGRPHC_ELGBLTY as a -- left join data_anltcs_dm_prod.state_submsn_type s on a.submtg_state_cd = s.submtg_state_cd and upper(s.fil_type) = 'ELG'
where
    (
        a.TMSIS_ACTV_IND = 1
        and (
